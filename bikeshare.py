...
def get_filters():
    ...
    while month not in ['january','february','march','april','may','june','all']:
    	month = input("Please enter month only from 'January to June' or 'all' to apply no filter  :  ")
    	month = month.lower()
    	month = month.replace(" ", "")
    ...
    while  day.lower() not in ['sunday','monday','tuesday','wednesday','thursday','saturday','all']:
    	day = input("Please enter a valid day of the week or 'all' to apply no filter  :  ")
    	day = day.lower()
    	day = day.replace(" ", "")
    print('-'*40)
